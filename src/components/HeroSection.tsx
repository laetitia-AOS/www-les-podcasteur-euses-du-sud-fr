...
import { Search, Hand, ArrowRight } from "lucide-react";
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden" style={{ backgroundColor: "hsl(40 20% 8%)" }}>
      <div className="relative z-10 container mx-auto px-6 max-w-6xl pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              <span
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-medium border tracking-wide"
                style={{
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl leading-[1.12] mb-5"
            >
              <span className="font-display font-bold text-white">Tu cherches.</span>
              <br />
              <span className="font-display font-bold text-white">Tu proposes.</span>
              <br />
              <span className="font-display font-bold text-sable">Tu crées.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-sm sm:text-base max-w-[380px] leading-relaxed mb-8"
            ...
            >
              <button
                ...
                className="group flex flex-col items-start gap-2 bg-primary text-primary-foreground rounded-2xl p-4 hover:bg-primary-hover transition-all shadow-lg shadow-primary/20"
              >
                <Search className="w-4 h-4" />
                <span className="font-display font-bold text-sm">Je cherche un profil</span>
                <span className="text-[11px] opacity-70">Explorer l'annuaire</span>
              </button>
              <button
                onClick={() => navigate("/referencer-mon-podcast")}
                className="group flex flex-col items-start gap-2 rounded-2xl p-4 transition-all"
                style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)" }}
              >
                <Hand className="w-4 h-4 text-sable" />
                <span className="font-display font-bold text-sm text-white">Je veux être trouvé·e</span>
                <span className="text-[11px]" style={{ color: "rgba(255,255,255,0.5)" }}>Créer mon profil</span>
              </button>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="relative space-y-2.5">
              <p className="text-[11px] font-medium uppercase tracking-wider mb-2" style={{ color: "rgba(255,255,255,0.4)" }}>Profils récents</p>
            ...
            <div className="relative mt-3">
              <div className="flex items-center gap-3 bg-background-pure rounded-xl p-3 shadow-lg">
                ...
                <button
                  onClick={() => navigate("/annuaire-podcasts")}
                  className="px-4 py-2 rounded-lg bg-primary text-primary-foreground text-xs font-bold hover:bg-primary-hover transition-all"
                >
                  Rechercher
                </button>
              </div>
              <div className="flex flex-wrap gap-2 mt-2.5">
                {["Monteur·euse", "Studio Marseille", "Voix off", "Coach podcast"].map((tag) => (
                  <button
                    key={tag}
                    onClick={() => navigate("/annuaire-podcasts")}
                    className="px-3 py-1 rounded-full text-[11px] font-medium transition-all hover:bg-primary/15"
        ...
        <motion.div
          ...
          className="flex items-center gap-8 sm:gap-10 text-sm pt-8 mt-6"
        ...
        >
          {[
            ...
            <div key={stat.label} className="flex flex-col">
              ...
              <span className="text-[10px] uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>{stat.label}</span>
            </div>
          ))}
        </motion.div>
      </div>
