...
const Footer = () => {
  return (
    <footer className="py-16 border-t border-primary/20 bg-footer">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-display font-bold text-lg text-foreground block leading-tight">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-muted-foreground">
            <Link to="/evenements-podcast" className="hover:text-secondary transition-colors">
              Événements
            </Link>
            ...
            <span className="w-1 h-1 rounded-full bg-border hidden sm:block" />
            <Link to="/conditions-utilisation" className="hover:text-secondary transition-colors">
              CGU
            </Link>
            <span className="w-1 h-1 rounded-full bg-border hidden sm:block" />
