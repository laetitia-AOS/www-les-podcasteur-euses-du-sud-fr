        ...
        >
          ...
          >
            <a
              ...
              className="inline-block bg-secondary text-secondary-foreground px-7 py-3.5 rounded-lg font-medium hover:brightness-110 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
            >
              Prendre contact
            </a>
          </motion.div>
