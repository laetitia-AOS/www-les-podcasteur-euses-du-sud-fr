            ...
            <div className="relative p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 mt-6 text-sm font-bold px-6 py-3 rounded-full hover:brightness-95 transition-all shadow-md bg-background text-foreground"
                >
