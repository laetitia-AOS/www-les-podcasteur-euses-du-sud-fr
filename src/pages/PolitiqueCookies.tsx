    ...
    <>
      ...
      <main className="min-h-screen py-20 md:py-32 bg-background">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="font-display font-bold text-3xl sm:text-4xl mb-4">Politique de cookies</h1>
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground space-y-8">
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">1. Qu'est-ce qu'un cookie ?</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">2. Types de cookies utilisés sur ce site</h2>
            ...
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">3. Finalité des cookies</h2>
            ...
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">4. Gestion et paramétrage des cookies</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">5. Cookies tiers</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">6. Mise à jour de la présente politique</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-bold text-xl text-foreground">7. Contact</h2>
              <p>
